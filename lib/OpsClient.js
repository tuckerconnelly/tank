...
this._getExtra=getExtra;}_createClass(OpsClient,[{key:'_makeSureConnected',value:function _makeSureConnected()


{var _this=this;
return new Promise(function(resolve,reject){
if(_this._ws.readyState===1){// 1 === WebSocket.OPEN
resolve();
return;}
...
if(_this._ws.readyState!==1)return;// 1 === WebSocket.OPEN
clearTimeout(timeout);
clearInterval(checkInterval);
resolve();},
OpsClient.CONNECTING_CHECK_INTERVAL);});}},{key:'request',value:function request(
...
_this2._ws.send(JSON.stringify({sid:_sid,id:id,name:name,payload:payload,extra:_this2._getExtra()}));});});}}]);return OpsClient;}();OpsClient.CONNECTING_CHECK_INTERVAL=10;OpsClient.CONNECTION_TIMEOUT=10000;exports.default=OpsClient;