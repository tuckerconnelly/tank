...
var MemorySessionManager=exports.MemorySessionManager=function(){function MemorySessionManager(){_classCallCheck(this,MemorySessionManager);this.
...
this._store[guaranteedSID]={sid:guaranteedSID};}return _context.abrupt('return',
...
OpsServer=
function OpsServer(wss,sessionManager,requests){var _this=this;_classCallCheck(this,OpsServer);
...
if(name===availableRequest)requestAction=requests[availableRequest];});_context2.prev=8;if(!(
...
ws.send(JSON.stringify({id:id,error:message}));case 25:case'end':return _context2.stop();}}},null,_this,[[8,20]]);});});};exports.default=OpsServer;